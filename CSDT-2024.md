...
Como primero ya que estaba dando errror el analisis del OWASP se sacp a un segundo job ya que este debia correr en linux quedando de la siguiente manera
![alt text](assets/image11.png)
Ademas de ciertos ajustes que toco hacerle a los parametros y la version de este, tambien se acomodo el comentario para que funcione tanto para pull request como para push ya que estaba teniendo problemas con eso tambien
